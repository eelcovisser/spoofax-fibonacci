...
public class FiboParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("fibo");
  ...
  { 
    FiboParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = FiboParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = FiboParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(FiboParseControllerGenerated.class);
    }
  ...
  { 
    return FiboParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
